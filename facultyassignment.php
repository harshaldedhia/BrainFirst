                ...
                <div class="row bg-title">
                    ...
                    <?php
                        ...
                        while($rows = mysqli_fetch_array($result)){
                            echo '<div class="col-md-12">';
                            echo '<div class="white-box" style="padding:30px">
                            <h3 class="title"><form method="post" action="gradeassignment.php"><input type="hidden" name="assignment_id" value='.$rows['assignment_id'].'><button type="submit" class="linkButton">'.$rows["about_assignment"].'</button></h3>
