            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href="<?php echo $usertype;?>home.php" class="waves-effect"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i><span class="hide-menu">Dashboard</span></a>
                    </li>
                    <li>
                        ...
                        <div class="white-box" style="margin-left: -40px; padding: 35px">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea rows="5" placeholder="Something about yourself" id="about_yourself" class="form-control form-control-line"><?php echo $about_yourself;?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
